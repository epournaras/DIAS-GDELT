...
# plot settings
db.rows <- 20000 # number of (most recent) rows to retrieve from database
...
# plot.count.db.R
# plot the DIAS aggreated count of each peer against the true count
# the true count is computed by taking the number of active peers at each eopch
