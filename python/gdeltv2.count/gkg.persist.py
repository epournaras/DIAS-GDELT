...
# postgres
pg_sql_insert_template = """INSERT INTO gdeltv2c(dt,peer,gkgrecordid,sqldate,ActionGeo_CountryCode,EventCount) 
    VALUES(%s,%s,%s,%s,%s,%s)"""
...
for ActionGeo_CountryCode in latest_values:
	try:
		...
		ret = pg_cursor.execute(pg_sql_insert_template,
		                        (dt, peer, gkgrecordid, sqldate, ActionGeo_CountryCode, EventCount,))
